...
// syntax highlighting
#define KEYWORD_FG TB_GREEN
#define KEYWORD_BG TB_DEFAULT

#define PUNCTUATION_FG TB_RED | TB_BOLD
...
#define CONSTANTS_FG (TB_RED | TB_BOLD)
#define CONSTANTS_BG TB_DEFAULT

#define VARIABLES_FG TB_GREEN
#define VARIABLES_BG
