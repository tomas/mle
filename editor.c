...
static int _editor_key_to_input(char* key, kinput_t* ret_input) {
    ...
    #define MLE_KEY_DEF(pckey, pmeta, pch, pkey) \
...
static void _editor_init_kmaps(editor_t* editor) {
    _editor_init_kmap(editor, &editor->kmap_normal, "mle_normal", "cmd_insert_data", 0, (kbinding_def_t[]){
        ...
        MLE_KBINDING_DEF("cmd_move_beginning", "C-home"),
        MLE_KBINDING_DEF("cmd_move_end", "M-/"),
        MLE_KBINDING_DEF("cmd_move_end", "C-end"),
        ...
        MLE_KBINDING_DEF("cmd_move_bracket_back", "C-up"),
        MLE_KBINDING_DEF("cmd_move_bracket_forward", "C-down"),

        // MLE_KBINDING_DEF("cmd_search", "C-f"),
        MLE_KBINDING_DEF("cmd_search", "C-w"),
        MLE_KBINDING_DEF("cmd_search_next", "C-g"),
        MLE_KBINDING_DEF("cmd_search_next", "F3"),
        MLE_KBINDING_DEF("cmd_find_word", "C-v"),
        MLE_KBINDING_DEF("cmd_isearch", "C-f"),
        ...
        MLE_KBINDING_DEF("cmd_uncut", "C-v"),
        ...
        MLE_KBINDING_DEF("cmd_prev", "M-,"),
        MLE_KBINDING_DEF("cmd_next", "M-."),
        ...
        MLE_KBINDING_DEF("cmd_indent", "tab"),
